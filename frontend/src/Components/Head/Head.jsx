  ...
  return (
    <div className="head" style={props.headStyle}>
      ...
      <div className="head_section-block">
        <span className="head_section" onClick={() => navigate("/home1")}>Home</span>
        <span className="head_section" onClick={() => navigate("/home2")}>Shop</span>
        <span className="head_section">Product</span>
        <span className="head_section">Contact us</span>
      </div>
      <div className="head_buttons-block">
        <img className="head_button" onClick={() => navigate("/home2")} src={searchIcon} />
